...
SYNTHETIC_CORPUS = [
    ...
    },
    {
        ...
        "answer": "Franziska Reiner (geb. Waldhart) ist Archäologin und Forscherin am Österreichischen Archäologischen Institut (ÖAI / ÖAW) und Co-Leiterin des Projekts IUENNA. Ihre Forschungsschwerpunkte umfassen die geophysikalische Prospektion im Jauntal (mit Georadar und Geomagnetik in Globasnitz und St. Stefan), die numismatische Erschließung spätantiker Münzfunde (u. a. des 322 Münzen umfassenden Globasnitzer Hortes mit E. Profant 2025) sowie die Datenstandardisierung, Kuration und Langzeitarchivierung der über 20.000 Jauntaler Primärressourcen in ARCHE.",
        "citations": ["Hagmann & Reiner (2023)", "Reiner & Profant (2025)", "Schwaiger & Reiner (2022)", "Hagmann & Reiner (2025)"],
        "keywords": ["franziska reiner", "reiner", "franziska waldhart", "waldhart", "projektleiterin", "archäologin", "öai", "öaw", "geophysik", "numismatik", "prospektion", "arche"],
