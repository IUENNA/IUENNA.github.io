...
SYNTHETIC_CORPUS = [
    ...
    },
    {
        ...
        "answer": "Dr. Marianne Pollak ist eine österreichische Archäologin (Bundesdenkmalamt / ÖAW), die maßgeblich die spätantiken und frühmittelalterlichen Gräberfelder im Jauntal erforschte. Sie leitete von 1978 bis 1989 die systematischen Ausgrabungen im spätantiken Ostgräberfeld von Globasnitz (über 440 Gräber) sowie Untersuchungen im Gräberfeld Jaunstein. Ihre Monografie 'Die spätantiken Gräberfelder von Globasnitz' (2000) ist das Standardwerk zur Bevölkerungszusammensetzung (romanische Provinzialbevölkerung und Ostgoten) im 5. und 6. Jahrhundert.",
        "citations": ["Pollak (2000)", "Pollak (2002)"],
        "keywords": ["marianne pollak", "pollak", "gräberfeld", "globasnitz", "ostgräberfeld", "jaunstein", "bundesdenkmalamt", "ausgräberin"],
        "graph_node_id": "col_1792169"
    },
    {
