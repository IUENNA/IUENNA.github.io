...
SYNTHETIC_CORPUS = [
    ...
    },
    {
        ...
        "lang": "de",
        "category": "Forschungsgeschichte & Personen",
        "question": "Wer ist Elke Profant und welchen Beitrag leistet sie im IUENNA-Projekt?",
        "variations": [
            "Wer ist Elke Profant?",
            "Elke Profant",
            "Forschung Elke Profant",
            "Was hat Elke Profant erforscht?",
            "Elke Profant ÖAI"
        ],
        "answer": "Elke Profant ist Forscherin am Österreichischen Archäologischen Institut (ÖAI) der ÖAW. Im Rahmen des Projekts IUENNA erforschte sie gemeinsam mit Franziska Reiner die zerstörungsfreie geophysikalische Prospektion im Jauntal (Reiner & Profant 2025: 'Iuenna und Umgebung − Geophysikalische Prospektion im Jauntal') und ist als Co-Autorin an der Aufbereitung der offenen Geodaten (tal_geodaten_open.gpkg) in ARCHE beteiligt.",
        "citations": ["Reiner & Profant (2025)", "Gugl et al. (2025)"],
        "keywords": ["elke profant", "profant", "geophysik", "prospektion", "geodaten", "geopackage", "öai", "öaw", "jauntal"],
    ...
    },
    {
        ...
        "answer": "Christian Gugl ist leitender Wissenschaftler am Österreichischen Archäologischen Institut (ÖAI / ÖAW) und Experte für römische Provinzialarchäologie und Siedlungstopografie. Er leitet die jüngste archäologische Neubewertung der Mikroregion Globasnitz. Gugl begründete die These, dass Globasnitz ein 7–9 ha großer vicus war, während die Straßenstation Iuenna der Tabula Peutingeriana beim Tscherberg lag, und analysierte die Großvilla St. Stefan.",
    ...
    },
    {
        ...
        "answer": "Dominik Hagmann ist Archäologe und Digital-Humanities-Spezialist am Österreichischen Archäologischen Institut (ÖAI / ÖAW) und Gesamtleiter des Projekts IUENNA ('Von der analogen Grabungsdokumentation zur FAIRen Forschungsdateninfrastruktur'). Gemeinsam mit Franziska Reiner (geb. Waldhart) und Nicola Math leitete und konzipierte er die digitale Rettung und Erschließung der über 20.000 analogen Grabungsdokumente aus dem Jauntal nach den FAIR- und CARE-Prinzipien für das Repositorium ARCHE.",
        "citations": ["Hagmann & Reiner (2023)", "Hagmann & Reiner (2025)", "Hagmann et al. (2024)"],
        "keywords": ["dominik hagmann", "hagmann", "projektleiter", "öai", "öaw", "fair", "retrodigitalisierung", "arche"],
        "graph_node_id": "per_1756729"
    },
    {
        "id": "qa_person_franziska_reiner",
        "lang": "de",
        "category": "Forschungsgeschichte & Personen",
        "question": "Wer ist Franziska Reiner und welche Rolle spielt sie im IUENNA-Projekt?",
        "variations": [
            "Wer ist Franziska Reiner?",
            "Franziska Reiner",
            "Franziska Waldhart",
            "Projektleitung Franziska Reiner",
            "Reiner IUENNA",
            "Was forscht Franziska Reiner?"
        ],
        "answer": "Franziska Reiner (geb. Waldhart) ist Archäologin und Forscherin am Österreichischen Archäologischen Institut (ÖAI / ÖAW) und Co-Leiterin des Projekts IUENNA. Ihre Forschungsschwerpunkte umfassen die geophysikalische Prospektion im Jauntal (mit Georadar und Geomagnetik in Globasnitz und St. Stefan; Reiner & Profant 2025), die Dokumentation spätantiker und frühmittelalterlicher Fundkomplexe sowie die Datenstandardisierung, Kuration und Langzeitarchivierung der über 20.000 Jauntaler Primärressourcen in ARCHE.",
        "citations": ["Hagmann & Reiner (2023)", "Reiner & Profant (2025)", "Schwaiger & Reiner (2022)", "Hagmann & Reiner (2025)"],
        "keywords": ["franziska reiner", "reiner", "franziska waldhart", "waldhart", "projektleiterin", "archäologin", "öai", "öaw", "geophysik", "prospektion", "arche"],
        "graph_node_id": "per_1756730"
    },
