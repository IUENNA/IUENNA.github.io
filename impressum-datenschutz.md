...
- **Chart.js:**
    - Bibliothek: [https://cdn.jsdelivr.net/npm/chart.js](https://cdn.jsdelivr.net/npm/chart.js)
    - CDN-Anbieter: **jsdelivr.net**
    - Datenschutzerklärung von jsdelivr.net: [https://www.jsdelivr.com/privacy-policy-cdn](https://www.jsdelivr.com/privacy-policy-cdn)

Beim Laden der Bibliothek wird die IP-Adresse der Besucher*innen unserer Website an die Server von jsdelivr.net übertragen. Diese Übertragung ist technisch erforderlich, damit die Bibliothek an den Browser ausgeliefert werden kann.

Die Verarbeitung der IP-Adresse erfolgt auf Grundlage unseres berechtigten Interesses (Art. 6 Abs. 1 lit. f DSGVO), um die fehlerfreie Bereitstellung der Website und die Darstellung von Diagrammen zu gewährleisten.
...
- **Inhaltserstellung**: Generative KI-Tools und Large Language Models (LLMs) (OpenAI ChatGPT-4o und ChatGPT o1, Google Gemini 1.5 Pro sowie das für die Datenstrukturierung und -bereinigung entwickelte, auf dem **ChatGPT 5.5 Instant** LLM basierende Custom GPT [IUENNA Refiner](https://chatgpt.com/g/g-Mckkm4Mjh-iuenna-refiner)) wurden genutzt, um bestimmte Inhalte dieser Website zu verfassen, zu optimieren oder zu verbessern.
