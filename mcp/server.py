...
TOOLS = [
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "node_or_id": {"type": "string", "description": "Node label, entity name (e.g. 'Franziska Reiner', 'Dominik Hagmann', 'Sabine Ladstätter', 'Michaela Binder', 'Hemmaberg', 'glo_geodaten_open.gpkg'), or ARCHE ID (e.g. '1756744', 'plc_1756734')."},
